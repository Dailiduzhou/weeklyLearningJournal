...
func RegisterUserHTTPServer(s *http.Server, srv UserHTTPServer) {
	...
	r.POST("/api/user", _User_GetUser0_HTTP_Handler(srv))
}
...
func (c *UserHTTPClientImpl) Register(ctx context.Context, in *CreateUserRequest, opts ...http.CallOption) (*CreateUserReply, error) {
