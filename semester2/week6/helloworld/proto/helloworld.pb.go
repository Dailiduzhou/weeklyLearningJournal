...
const file_proto_helloworld_proto_rawDesc = "" +
	...
	"\n" +
	"Helloworld\x123\n" +
	"\x04Call\x12\x13.helloworld.Request\x1a\x14.helloworld.Response\"\x00\x12I\n" +
	"\x06Stream\x12\x1c.helloworld.StreamingRequest\x1a\x1d.helloworld.StreamingResponse\"\x000\x01B\x14Z\x12./proto;helloworldb\x06proto3"
...
var file_proto_helloworld_proto_depIdxs = []int32{
	...
	2, // 2: helloworld.Helloworld.Call:output_type -> helloworld.Response
	4, // 3: helloworld.Helloworld.Stream:output_type -> helloworld.StreamingResponse
